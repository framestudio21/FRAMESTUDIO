    ...
    <Layout>
        <div className={styles.errormainbody}>
            <div className={styles.searchboxdiv}>
                ...
                <div className={styles.subtitle}>Apologies, but we were unable to find what you were looking for.</div>
                </div>
                <form className={styles.searchbox} onSubmit={handleSearch} onClick={handleContainerClick}>
                <i className={`material-icons ${styles.icon}`} alt="search" >search</i>
                <input
                  type="text"
            ...
            <button className={styles.backbtn} onClick={handleBackClick}>back to previous</button>
        </div>
    </Layout>
    </>
  )
